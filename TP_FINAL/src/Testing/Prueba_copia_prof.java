...
public class Prueba_copia_prof {
    ...
    public static void main(String[] args) {
        ...
        // //Acceso indexado
        // List<Object> fila = tablaCopia.indexFila("1"); // Accede a la fila con
        // etiqueta "1"
        // System.out.println("Fila 1: " + fila);

        // // Acceso a una columna completa
        // List<Object> columna = tablaCopia.indexColumna("Numerica"); // Accede a la
        // columna "Nombre"
        // System.out.println("Columna 'Numerica': " + columna);

        // // Acceso a una celda específica
        // Object celda = tablaCopia.indexCelda("1", "Numerica"); // Accede a la celda
        // en fila "1" y columna "Nombre"
        ...
        // Tabla tabla_seleccion = tablaCopia.seleccionar(Arrays.asList("1"),
        // Arrays.asList("Numerica"));
        ...
        // Tabla tablaFiltrada = tablaCopia.filtrar(columnas, predicados,
        // OperadorLogico.AND);
        // tablaFiltrada.info();
    }
}
